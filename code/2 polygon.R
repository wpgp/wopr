...
# features <- suppressWarnings(st_centroid(features))

#----- for testing -------#
nfeat=10;features=st_read(dsn='in',layer='lgas');features=features[172:(171+nfeat),]
...
# save results as csv
write.csv(totals, file='out/poptotals.csv')

# save features to disk as geojson
st_write(totals, dsn='out/poptotals.geojson', layer='out/poptotals.geojson', driver='GeoJSON', delete_dsn=T)

# cleanup
rm(features, totals);gc()
