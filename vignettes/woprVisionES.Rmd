---
title: Una visión general de la aplicación web woprVision
output: 
  rmarkdown::html_vignette:
    toc: false
vignette: >
  %\VignetteIndexEntry{Una vision general de la aplicacion web woprVision}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
  \usepackage[utf8]{inputenc}
---

Grupo de Investigación de WorldPop  
...
2. Recuperar las estimaciones de población dentro de las áreas geográficas definidas por el usuario haciendo clic en el mapa,
3. Obtener estimaciones del tamaño de la población para grupos demográficos específicos (es decir, edad y sexo), y
4. 4. Obtener estimaciones probabilísticas de incertidumbre para todas las estimaciones de población.
5. 5. Ejecute la aplicación web <a href='https://apps.worldpop.org/woprVision' target='_blank'>woprVision</a> localmente desde la consola R.  
...
woprVision es parte del paquete <a href='https://github.com/wpgp/wopr' target='_blank'>wopr</a> para el lenguaje de programación estadística R. woprVision fue creado usando los paquetes de brillantes y folletos para R (Chang et al. 2018, Cheng et al. 2018, R Core Team 2019). Vea la pestaña "Paquete R" para más información. 
...
6. 6. Pulse "Enviar" para recuperar la estimación de la población de esa zona  
7. Use los controles deslizantes para seleccionar un grupo de edad y sexo  
8. Haga clic en "Enviar" para recuperar la estimación de la población del grupo demográfico seleccionado en el lugar elegido  

## Componentes de la aplicación 

### User Controls
El panel de control del usuario está en el lado izquierdo de la pestaña "Mapa" con controles que puede utilizar para recuperar las estimaciones de población.

**Elija los datos de población**  
Seleccione el conjunto de datos de población que desea consultar. Esto incluye un país y un número de versión. Puede leer más sobre el conjunto de datos seleccionado en la pestaña "Léame datos". 

**Seleccione una ubicación**  
Puedes seleccionar las ubicaciones de los puntos con la herramienta "Haz clic en el mapa". Puedes dibujar un polígono para seleccionar un área con la herramienta "Dibuja un área". Puedes subir un archivo geojson con puntos o polígonos con la herramienta "Subir archivo". 

**Botón de envío**  
Una vez que haya seleccionado una ubicación (utilizando las herramientas de selección "Haga clic en el mapa" o "Dibuje un área"), utilice el botón "Enviar" para recuperar las estimaciones de población para esa ubicación desde los servidores del WOPR. 
...
- "Intervalo" es el tipo predeterminado. Utilícelo si quiere saber el rango de valores en el que probablemente se encuentre la población (por ejemplo, el 95% de probabilidades de que la población esté entre x e y).  
...
**Límite de población**  
El umbral de población que se indica aquí se utilizará para calcular la probabilidad de que la población supere ese umbral. El valor por defecto es 100. Esto devolverá la probabilidad de que la población exceda de 100 personas.
...
- **Oscuridad** Un mapa base oscuro del <a href='https://leaflet-extras.github.io/leaflet-providers/preview/#filter=CartoDB.DarkMatter' target='_blank'>CartoDB.DarkMatter</a> Proveedor del mapa base del folleto. Este mapa base proporciona el máximo contraste con la capa de población.

- **Map** Un mapa base de Open Street Maps llamado <a href='https://leaflet-extras.github.io/leaflet-providers/preview/#filter=OpenStreetMap.Mapnik' target='_blank'>OpenStreetMap.Mapnik</a> de los proveedores del Folleto. Este mapa base proporciona nombres de lugares y calles que pueden ser útiles.

- **Satélite** Mapa base de imágenes satelitales ESRI <a href='https://leaflet-extras.github.io/leaflet-providers/preview/#filter=Esri.WorldImagery' target='_blank'>Esri.WorldImagery</a> de los proveedores del Folleto. Este mapa base proporciona imágenes satelitales que son más útiles cuando se hace un zoom.
...
- **Área personalizada** Una capa de mapa que muestra el polígono que se ha dibujado con la herramienta de selección "Dibujar un área".
...
- **Borrar Capas** Esta herramienta se puede usar para borrar el polígono que ha dibujado.
...
**Mapa**  
Esta es la pestaña predeterminada. Se puede utilizar para alternar entre conjuntos de datos y recuperar estimaciones de población para áreas específicas haciendo clic en el mapa o dibujando un polígono. Esta pestaña contiene un mapa del Folleto en el centro, un panel de control de usuario a la izquierda y un panel de resultados a la derecha. 

**Guardado**  
Esta pestaña tiene una hoja de cálculo que contiene cualquier estimación de población que hayas guardado. La hoja de cálculo puede guardarse en tu ordenador como un archivo .csv haciendo clic en "Descargar" o puede eliminarse haciendo clic en "Borrar". 
...
**Data Readme**  
La pestaña "Data Readme" proporciona la declaración de divulgación de datos del WorldPop para el conjunto de datos de población que está actualmente seleccionado en la pestaña "Mapa". Las declaraciones de divulgación proporcionan información sobre el conjunto de datos de población y cómo se produjo. 
