...
An overview of the WOPR API backend for developers
</h1><br>

#### Doug Leasure and Maksym Bondarenko  
...
### WOPR API Endpoints
This is a listing of WOPR API endpoints. This document provides instructions how to utilize each endpoint.
...
**doi** is the official published DOI (digital object identifier) that can be used for official citations. The DOI refers to a stable and permanent version of the file that is stored at <a href='ftp://ftp.worldpop.org/repo/wopr' target="_blank">ftp://ftp.worldpop.org/repo/wopr</a>. These files may differ slightly from the files stored in the <a href="https://wopr.worldpop.org" target="_blank">WorldPop Open Population Repository</a> if minor changes were made since the time of the DOI publication.  
...
**iso3** The <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" target="_blank">ISO country code</a> of the country to query (e.g. `NGA`).  
