...
**doi** is the official published DOI (digital object identifier) that can be used for citations. The DOI refers to a stable and permanent version of the file that is stored at [ftp://ftp.worldpop.org/repo/wopr](ftp://ftp.worldpop.org/repo/wopr). These files may differ slightly from the files stored at [wopr.worldpop.org](https://wopr.worldpop.org) if minor changes were made since the time of the DOI publication.  
